...
CREATE_COURSES_TABLE = "CREATE TABLE IF NOT EXISTS courses (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, credit INTEGER, grade INTEGER, status TEXT, user TEXT, url TEXT, UNIQUE(id, user));"
