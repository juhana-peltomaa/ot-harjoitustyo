...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortille_voi_ladata_negatiivista_summaa(self):
        self.kortti.lataa_rahaa(-25)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_syo_edullisesti_onnistuu_tasa_saldolla(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_onnistuu_tasa_saldolla(self):
